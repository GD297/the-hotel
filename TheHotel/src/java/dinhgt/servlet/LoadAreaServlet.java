 ...
 * @author Admin
 */
@WebServlet(name = "LoadAreaServlet", urlPatterns = {"/LoadAreaServlet"})
public class LoadAreaServlet extends HttpServlet {
    ...
    static final Logger LOGGER = Logger.getLogger(LoadAreaServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            areaDAO.loadAreaAvailableRoom();
            List<TblAreaDTO> listArea = areaDAO.getListArea();
            request.setAttribute("LIST_AREA_AVAILABLE", listArea);
