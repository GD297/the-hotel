...
import dinhgt.tblfeedback.TblFeedbackDTO;
 ...
 * @author Admin
 */
@WebServlet(name = "LoadFeedbackServlet", urlPatterns = {"/LoadFeedbackServlet"})
public class LoadFeedbackServlet extends HttpServlet {

    static final Logger LOGGER = Logger.getLogger(LoadFeedbackServlet.class);
    private final String LOGIN_PAGE = "loginPage1.html";
    private final String FEEDBACK_PAGE = "showFeedback.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            fbDAO.loadFeedback(hotelID);
            List<TblFeedbackDTO> listFB = fbDAO.getListFb();
