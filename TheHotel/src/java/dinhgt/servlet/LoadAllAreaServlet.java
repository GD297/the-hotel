 ...
 * @author Admin
 */
@WebServlet(name = "LoadAllAreaServlet", urlPatterns = {"/LoadAllAreaServlet"})
public class LoadAllAreaServlet extends HttpServlet {

    private final String LOGIN_PAGE = "loginPage1.html";
    private final String HOME_PAGE = "homePage1.jsp";
    static final Logger LOGGER = Logger.getLogger(LoadAllAreaServlet.class);
