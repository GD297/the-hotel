...
public class ActionCartServlet extends HttpServlet {
    ...
    private final String UPDATE_CART_CONSTRUCTOR = "UpdateAmountServlet";
    private final String REMOVE_CART_CONSTRUCTOR = "RemoveHotelServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (btn.equals("Update")) {
                url = UPDATE_CART_CONSTRUCTOR;
            } else if (btn.equals("Remove")) {
                url = REMOVE_CART_CONSTRUCTOR;
            }
        } finally {
