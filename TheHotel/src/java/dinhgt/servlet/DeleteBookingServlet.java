...
static final Logger LOGGER = Logger.getLogger(DeleteBookingServlet.class);
    private final String LOGIN_PAGE = "loginPage1.html";
    private final String LOAD_ORDER = "LoadHistoryServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (userID != null) {
                ...
                boolean result = orderDAO.updateOrderBooking(userID, orderID, orderDate);
                if (result) {
                    url = LOAD_ORDER;
                }
            }
